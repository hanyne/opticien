  ...
  return (
    <div style={styles.pageContainer}>
      ...
      <section style={styles.aboutSection}>
        <h2 style={styles.sectionTitle}>À propos de Barbie Vision</h2>
        <p style={styles.aboutText}>
          Fondée en 2020, Barbie Vision est une entreprise dédiée à l'élégance et à la clarté visuelle.
          Nous proposons une large gamme de lunettes, des lunettes de soleil aux lunettes de vue, en passant
          par des lentilles de contact. Notre mission est de sublimer votre regard tout en vous offrant une
          vision parfaite. Grâce à notre technologie d'essayage virtuel, vous pouvez essayer vos lunettes
          en ligne, et notre service de montage pour opticiens garantit un suivi précis et professionnel.
        </p>
      </section>
      ...
      <section style={styles.teamSection}>
        ...
        <div style={styles.teamGrid}>
          <div style={styles.teamCard} className="team-card">
            <h3 style={styles.teamName}>Marie Dubois</h3>
            <p style={styles.teamRole}>Fondatrice & Opticienne</p>
            <p style={styles.teamBio}>
              Avec plus de 15 ans d'expérience, Marie est passionnée par l'optique et le design.
            </p>
          </div>
          <div style={styles.teamCard} className="team-card">
            <h3 style={styles.teamName}>Lucas Martin</h3>
            <p style={styles.teamRole}>Spécialiste en montage</p>
            <p style={styles.teamBio}>
              Lucas excelle dans la création de montures sur mesure pour nos clients.
            </p>
          </div>
          <div style={styles.teamCard} className="team-card">
            <h3 style={styles.teamName}>Sophie Laurent</h3>
            <p style={styles.teamRole}>Responsable clientèle</p>
            <p style={styles.teamBio}>
              Sophie veille à ce que chaque client vive une expérience exceptionnelle.
            </p>
          </div>
        </div>
      </section>
